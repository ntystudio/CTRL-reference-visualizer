...
#include "LrvHitProxy.h"

struct FLrvDebugVisualizerCache
{
...
class CTRLLEVELREFERENCEVIEWER_API FLrvDebugVisualizer : public FComponentVisualizer
{
public:
...
private:
	...
	HLrvHitProxy* LastHitProxy = nullptr;

	static FVector GetActorOrigin(const AActor* Actor);

protected:
	inline static FLrvDebugVisualizerCache Cache;
